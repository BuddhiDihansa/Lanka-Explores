      ...
      <div className="relative z-10 flex flex-col items-center px-6 text-center">
        <div
          className={`relative mb-8 transition-all duration-1000 ease-out ${
            showMap ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-6 scale-95"
          }`}
        >
          <div className="absolute inset-0 -z-10 rounded-[1.5rem] bg-amber-400/20 blur-3xl" />
          <div className="relative w-72 sm:w-80 md:w-96 aspect-[3/2] overflow-hidden rounded-xl bg-transparent">
            <Image
              src="/images/sri-lanka-flag.jpg"
              alt="Sri Lanka flag"
              fill
              priority
